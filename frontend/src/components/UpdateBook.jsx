...
const UpdateBook = () => {
    ...
    return (
        <div className='w-full flex justify-center'>
            <form role="form" class=" w-96 text-center border border-light p-5" onSubmit={update} enctype="multipart/form-data">

                <p class="h4 mb-4">update Book</p>
                <label>Name</label>
                <input value={upd.nom} onChange={(e) => setName(e.target.value)} type="text" id="defaultSubscriptionFormPassword" className="form-control mb-4 text-black" placeholder="name" />
